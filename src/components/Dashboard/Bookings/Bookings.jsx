  ...
  return (
    <div className=' pr-4 xl:pr-[77px] pt-[69px] h-[1255px] lg:h-[1210px] pb-3 overflow-hidden overflow-y-scroll'>
      <div className=' flex justify-between'>
        ...
        <button type='button' className=' rounded-[10px] flex items-center justify-center text-center shadow-dashboard w-[190px] h-[68px] font-semibold text-[25px] xl:text-[32px] text-[#6348A5]'>Book Now</button>
      </div>

      {/**Types of bookings */}
      <div className=' flex gap-[15%] mt-[41px]'>
        <button className=' flex flex-col gap-[5px]'>
          <h1 className=' font-medium text-[25px] xl:text-[32px] text-[#51336A]'>Current bookings</h1>
          <div className=' w-[190px] xl:w-[246px] h-1 bg-gradient-to-r from-transparent to-[#51336A]' />
        </button>

        <button className=' flex flex-col gap-[17px]'>
          <h1 className=' font-medium text-[#8B99B1] text-[25px] xl:text-[32px]'>Past bookings</h1>
        </button>
      </div>
      ...
      <div className=' w-full mt-[30px] flex flex-col gap-[30px]'>
        <div className=' flex justify-between border-l-[11px] py-6 pl-[12px] lg:pl-[30px] pr-[11px] border-l-[#51336A] rounded-[10px] shadow-dashboard'>
          ...
          <div className=' flex flex-col gap-[18px] lg:gap-[28px]'>
            <div className='flex gap-2 lg:gap-5 font-medium text-[25px] xl:text-[32px]'>
          ...
          <div className=' flex flex-col gap-6'>
            ...
            <button type='button' className=' rounded-tr-[16px] rounded-bl-[16px] shadow-dashboard px-5 font-semibold text-[25px] xl:text-[32px] text-[#6348A5]'>View</button>
          </div>
        </div>
