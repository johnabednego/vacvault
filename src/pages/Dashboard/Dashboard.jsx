    ...
    return (
        <div>
            ...
            <div className=' z-10 w-full bg-white fixed p-2 h-fit text-[#51336A] sm:hidden'>
                ...
                <div className={` ${openMenu?"flex z-[8] mt-8 ":"hidden z-0"} sm:flex ${open ? " w-[96%] xs:w-[90%] sm:w-[200px] md:w-[300px] lg:w-[422px]" : "w-[165px] "} shadow-dashboard rounded-tr-[30px] rounded-br-[30px] sm:h-full pl-[15px] pt-[36px] absolute bg-white sm:relative duration-1000`}>
